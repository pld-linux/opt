...
opt jest biblioteką zawierającą funkcje pozwalające analizować opcje i
parametry w programie C przesyłane przez linię poleceń, pliki z
parametrami, zmienne środowiska lub wbudowane interaktywne menu. opt
jest podobny do tego do czego dąży standardowa funkcja getopt() ale ma
inny (lepszy) interfejs programisty oraz więcej możliwości.
